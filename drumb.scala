...
//   if (data.length != 0) {
//     val currentBln = yearly_yield(data,balance,year)
//     compound_yield(data.drop(1),currentBln,year + 1)
...
//   	val year = years.end - years.start
// 	  compound_yield(deltas, start_balance, year)
// }
